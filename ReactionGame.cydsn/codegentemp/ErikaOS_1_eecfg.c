 ...
 **************************************************************************/
    ...
    int EE_cortex_mx_stack_6[TASK_6_STACK_SIZE];	/* Task 6 (tsk_background) */
    #endif
    ...
    struct EE_TOS EE_cortex_mx_system_tos[EE_CORTEX_MX_SYSTEM_TOS_SIZE] = {
        ...
        #endif
        #ifdef TASK_6_STACK_SIZE
        ,{(EE_ADDR)(&EE_cortex_mx_stack_6[(TASK_6_STACK_SIZE) - CORTEX_MX_INIT_TOS_OFFSET])}    /* tsk_background*/
        #endif
        #ifdef TASK_7_STACK_SIZE
 ...
 **************************************************************************/
    ...
    const EE_oo_counter_object_ROM_type   EE_oo_counter_object_ROM[EE_COUNTER_OBJECTS_ROM_SIZE] = {
        ...
        #endif
        #if EE_MAX_ALARM > 1
        ,{0, alarm_randomwait, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 2
        ,{0, alarm_1sectimeout, EE_ALARM }
        #endif
        #if EE_MAX_ALARM > 3
