...
enum LEDid
    ...
    typedef enum LEDid LEDid_t;
   
enum LEDOnOff
    {
        LED_OFF = 0, /**< Led state represents LED OFF>**/
        LED_ON = 1 /**< Led state represents LED ON>**/
    };
    typedef enum LEDOnOff LEDOnOff_t;
...
/**This is an array of type ledOnOff state represnts state of each LEDs ***/
static LEDOnOff_t LED_STATE[LED_ALL] = {LED_OFF,LED_OFF,LED_OFF};
